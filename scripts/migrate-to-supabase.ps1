...
# Ejecutar desde la raíz del proyecto: ./scripts/migrate-to-supabase.ps1
...
Write-Host "=== 1) Creando dump desde Docker Postgres ===" -ForegroundColor Cyan
...
Write-Host "`n=== 2) Restaurando en Supabase ===" -ForegroundColor Cyan
