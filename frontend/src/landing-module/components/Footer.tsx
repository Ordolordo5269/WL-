        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start mb-12">
            ...
            <div className="lg:col-span-2 text-center lg:text-center">
              ...
              >
                <span className="bg-gradient-to-r from-white via-cyan-100 to-blue-200 bg-clip-text text-transparent font-semibold tracking-wide relative">
                  WORLDLORE
                  <div className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-full h-0.5 bg-gradient-to-r from-cyan-400/40 via-blue-500/30 to-transparent rounded-full"></div>
                </span>
              </motion.h2>
            ...
            >
              ...
              <div className="space-y-4 flex flex-col items-center lg:items-center">
                <motion.a 
