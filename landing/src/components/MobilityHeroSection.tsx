...
const FeatureBadge = memo(({ icon, text }: { icon: string; text: string }) => (
  <motion.div
    className="flex items-center gap-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl px-4 py-3 hover:bg-white/10 transition-all duration-300 opacity-0"
    variants={{
      hidden: { opacity: 0 },
      visible: { 
        opacity: 1,
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <FeatureBadge icon="🌍" text="Travel Requirements Analysis" />
              <FeatureBadge icon="🥾" text="Trails.AI Routes" />
              <FeatureBadge icon="🎯" text="Personalized Recommendations" />
              <FeatureBadge icon="🤖" text="Personal AI Assistant" />
            </motion.div>
      ...
      <ComingSoonModal 
        ...
        description={
          <>
            We’re building <span className="text-white font-medium">Mobility AI</span>. A live view of how people move across the world, and what those shifts signal.
            <br /><br />
            Soon you’ll be able to explore movement flows, detect anomalies, and simulate how events impact mobility in real time.
          </>
        }
      />
    </section>
