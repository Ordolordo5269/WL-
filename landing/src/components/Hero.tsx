  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      >
        ...
        >
          <motion.div
            className="px-10 py-4 bg-gradient-to-r from-purple-600 via-purple-700 to-blue-600 text-white text-lg font-semibold rounded-lg shadow-2xl border border-purple-500/30 relative overflow-hidden cursor-pointer"
            style={{
          ...
          >
            ...
            <motion.div
              className={`absolute inset-0 opacity-0 ${styles.overlayGradient}`}
        ...
        >
          <motion.div
            className={`w-3 h-3 rounded-full ${styles.aiDotGradient}`}
            animate={{ 
              scale: [1, 1.3, 1], 
              opacity: [0.7, 1, 0.7],
              background: [
