              ...
              >
                ...
                <div className="relative w-[500px] h-[320px] bg-gradient-to-b from-gray-700 via-gray-800 to-gray-900 rounded-t-2xl shadow-2xl">
                  ...
                  <div className="absolute inset-2 bg-black rounded-xl overflow-hidden border border-gray-600">
                    ...
                    {/* Browser Content */}
                    <div className="h-full bg-black relative overflow-hidden flex items-center justify-center">
                      {/* Placeholder for future project screenshot */}
                      <span className="text-white/20 text-sm">Project Screenshot Placeholder</span>
                    </div>
                  </div>
