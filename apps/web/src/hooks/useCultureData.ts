...
import type { TCultureData } from '../services/culture-service';
...
export function useCultureData(iso3: string | null, countryName: string | null, enabled: boolean = true): UseCultureDataReturn {
