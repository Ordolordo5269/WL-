...
/* ─── Physical Layer Source Metadata (equivalent to Instrument Info) ─── */

export type PhysicalSourceKey = 'rivers' | 'lakes' | 'ranges' | 'peaks' | 'geothermal' | 'tectonics' | 'arid-zones';

export interface PhysicalSourceInfo {
  sourceName: string;
...
export const PHYSICAL_SOURCE_INFO: Record<PhysicalSourceKey, PhysicalSourceInfo> = {
  rivers: {
    sourceName: 'Fluvial Network Division',
    sourceDescription: 'WorldLore\u2019s fluvial intelligence unit traces every major river system on the planet \u2014 from headwater streams in alpine catchments to vast deltaic networks discharging into the ocean. Stream gauge telemetry and terrain-derived flow models are fused into a continuously updated drainage atlas.',
    divisions: ['River Systems', 'Watersheds'],
    networkType: 'Fluvial discharge monitoring',
    coverage: 'All continental drainage basins',
    networkDescription: 'A planetary-scale river monitoring infrastructure that tracks discharge volumes, seasonal flooding patterns, and hydrological connectivity across every major watershed.',
    image: '/sources/hydrology.svg',
  },
  lakes: {
    sourceName: 'Lacustrine Monitoring Array',
    sourceDescription: 'WorldLore\u2019s lacustrine division catalogues every significant inland water body on Earth \u2014 glacial lakes, tectonic rift basins, endorheic seas, and artificial reservoirs. Surface area, depth profiles, and water level fluctuations are tracked continuously.',
    divisions: ['Lake Basins', 'Inland Seas'],
    networkType: 'Lacustrine level monitoring',
    coverage: 'All inland water bodies',
    networkDescription: 'A global lake monitoring system that tracks water levels, surface extent, and seasonal variability across every major freshwater and saline lake on the planet.',
    image: '/sources/lakes.svg',
  },
  ranges: {
    sourceName: 'Orographic Survey Division',
    sourceDescription: 'WorldLore\u2019s orographic analysts map every major mountain range on the planet \u2014 collision zones, fold belts, and volcanic arcs. Each range is profiled by tectonic origin, geological age, and lithological composition to reveal the forces that shaped the continental skyline.',
    divisions: ['Mountain Ranges', 'Fold Belts'],
    networkType: 'Orographic terrain survey',
    coverage: 'All continental mountain systems',
    networkDescription: 'A comprehensive mountain range mapping network that combines radar altimetry, geological formation data, and tectonic stress models into a unified orographic database.',
    image: '/sources/terrain.svg',
  },
  peaks: {
    sourceName: 'Summit Index Network',
    sourceDescription: 'WorldLore\u2019s summit index records every significant peak on Earth with precision altitude, topographic prominence, and isolation data. From the 8,000-metre giants of the Greater Ranges to isolated volcanic cones on oceanic islands \u2014 each summit is individually surveyed and catalogued.',
    divisions: ['Peak Summits', 'Prominence Index'],
    networkType: 'Precision altimetry survey',
    coverage: 'Global summit catalogue',
    networkDescription: 'A high-precision summit monitoring system that tracks elevation changes, glacial retreat at altitude, and maintains the definitive catalogue of Earth\u2019s highest points.',
    image: '/sources/peaks.svg',
  },
  geothermal: {
    sourceName: 'Geothermal Surveillance Array',
    sourceDescription: 'WorldLore\u2019s geothermal monitoring array tracks every known Holocene volcano on Earth. Eruption histories, magma composition profiles, and real-time seismic tremor data are correlated to maintain a living risk assessment of volcanic activity worldwide.',
    divisions: ['Volcanic Monitoring'],
    networkType: 'Seismo-thermal network',
    coverage: 'All volcanic zones',
    networkDescription: 'A global volcanic surveillance system monitoring seismic activity, ground deformation, and thermal emissions across every active and dormant volcanic centre.',
    image: '/sources/geothermal.svg',
  },
  tectonics: {
    sourceName: 'Tectonic Analysis Division',
    sourceDescription: 'WorldLore\u2019s seismic intelligence division maps every plate boundary, transform fault, and subduction zone on the planet. Continuous seismic waveform analysis reveals where Earth\u2019s lithosphere is actively deforming, rifting, and colliding.',
    divisions: ['Plate Boundaries', 'Seismic Zones'],
    networkType: 'Seismic waveform network',
    coverage: 'All tectonic margins',
    networkDescription: 'A planetary-scale seismic monitoring grid that traces crustal stress patterns and maps the geometry of every major fault system in real time.',
    image: '/sources/tectonics.svg',
  },
  'arid-zones': {
    sourceName: 'Arid Zones Climate Division',
    sourceDescription: 'WorldLore\u2019s climate analysts chart every major desert and hyper-arid region on the planet. Aridity indices, surface albedo measurements, and desertification trend data are compiled into a comprehensive atlas of Earth\u2019s driest landscapes.',
    divisions: ['Desert Classification'],
    networkType: 'Climate aridity survey',
    coverage: 'Subtropical & continental arid belts',
    networkDescription: 'A climate monitoring system tracking precipitation deficits, sand sea migration, and long-term desertification trends across all major arid zones.',
    image: '/sources/arid-zones.svg',
  },
};

export const PHYSICAL_LAYER_SOURCE_MAP: Record<PhysicalLayerType, PhysicalSourceKey> = {
  rivers: 'rivers',
  ranges: 'ranges',
  peaks: 'peaks',
  lakes: 'lakes',
