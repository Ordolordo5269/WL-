...
interface CountrySidebarProps {
  ...
  onCitiesLoaded?: (cities: any[]) => void;
}

export default function CountrySidebar({ isOpen, onClose, countryName, onNavigateToCity: _onNavigateToCity, onCitiesLoaded: _onCitiesLoaded }: CountrySidebarProps) {
