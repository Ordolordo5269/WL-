...
export default function CountryKPIs({ countryData, economyData, isLoading }: CountryKPIsProps) {
  ...
  const [_trendsLoading, setTrendsLoading] = useState(true);
  ...
  const displayGdpTrend = gdpTrend.changePercent !== null ? gdpTrend : { value: null, changePercent: null, isPositive: true };
  const displayInflationTrend = inflationTrend.changePercent !== null ? inflationTrend : { value: null, changePercent: null, isPositive: false };
